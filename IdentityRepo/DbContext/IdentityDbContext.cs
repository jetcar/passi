...
using ApiResource = IdentityServer4.EntityFramework.Storage.Entities.ApiResource;
using ApiScope = IdentityServer4.EntityFramework.Storage.Entities.ApiScope;
using Client = IdentityServer4.EntityFramework.Storage.Entities.Client;
using IdentityResource = IdentityServer4.EntityFramework.Storage.Entities.IdentityResource;
using ILogger = Serilog.ILogger;
using PersistedGrant = IdentityServer4.EntityFramework.Storage.Entities.PersistedGrant;
