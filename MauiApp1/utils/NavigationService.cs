...
namespace MauiApp1.utils
{
    public class NavigationService : INavigationService
    {
        ...
        public async Task PushModalSinglePage(BaseViewModel viewModel)
        {
            ...
            pageType = pageType.Replace("ChatViewModel", "MauiApp1").Replace("ViewModel", "View");
        ...
        public async Task PopModal()
        {
            ...
            page.Appearing -= ((ChatBaseViewModel)page.BindingContext).OnAppearing;
            page.Disappearing -= ((ChatBaseViewModel)page.BindingContext).OnDisappearing;
