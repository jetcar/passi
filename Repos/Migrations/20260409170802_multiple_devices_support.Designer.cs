...
namespace Repos.Migrations
{
    ...
    [Migration("20260409170802_multiple_devices_support")]
    partial class multiple_devices_support
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.UserDeviceDb", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex(new[] { "DeviceId" }, "IX_UserDevices_DeviceId");

                    b.HasIndex(new[] { "ModifiedById" }, "IX_UserDevices_ModifiedById");

                    b.HasIndex(new[] { "UserId" }, "IX_UserDevices_UserId");

                    b.HasIndex(new[] { "UserId", "DeviceId" }, "IX_UserDevices_UserId_DeviceId")
                        .IsUnique();
