...
using WebApp.AutomaticTokenManagement;
    ...
    public static class OpenIdExtensions
    {
            ...
            string identityUrl, string returnUrl, string passiUrl, string clientId, string clientSecret)
        {
            ...
            return builder.AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
            {
                ...
                options.CallbackPath = new PathString(OpenIdDefaults.CallbackPath);
                ...
                options.Events = new OpenIdConnectEvents
                {
                    ...
                    {
                        context.ProtocolMessage.RedirectUri = $"https://{context.HttpContext.Request.Host.ToString()}{returnUrl}";
