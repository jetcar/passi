...
This privacy policy ("policy") will help you understand how Passi ("us", "we", "our") uses and
protects the data you provide to us when you visit and use passi.cloud ("website", "service").
...
- To verify that browser and smart device belong to same person and forward signed data from application to website where you try to login.

## Safeguarding and Securing the Data

Passi is committed to securing your data and keeping it confidential. Passi has done all in its
...
Our website contains links that lead to other websites. If you click on these links Passi is not
...
Passi will not lease, sell or distribute your personal information to any third parties, unless we
