...
namespace IdentityServer4.ResponseHandling.Default
{
    ...
    public class DeviceAuthorizationResponseGenerator : IDeviceAuthorizationResponseGenerator
    {
        ...
        public DeviceAuthorizationResponseGenerator(IdentityServerOptions options, IUserCodeService userCodeService, IDeviceFlowCodeService deviceFlowCodeService, ILogger<DeviceAuthorizationResponseGenerator> logger)
        {
            Options = options;
