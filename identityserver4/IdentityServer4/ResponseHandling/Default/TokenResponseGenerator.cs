...
namespace IdentityServer4.ResponseHandling.Default
{
    ...
    public class TokenResponseGenerator : ITokenResponseGenerator
    {
        ...
        public TokenResponseGenerator(ITokenService tokenService, IRefreshTokenService refreshTokenService, IScopeParser scopeParser, IResourceStore resources, IClientStore clients, ILogger<TokenResponseGenerator> logger)
        {
