...
namespace IdentityServer4.Services.Default
{
    ...
    public class DefaultTokenService : ITokenService
    {
        ...
        public virtual async Task<Token> CreateIdentityTokenAsync(TokenCreationRequest request)
        {
            ...
            // add iat claim
            claims.Add(new Claim(JwtClaimTypes.IssuedAt, new DateTimeOffset(DateTime.UtcNow).ToUnixTimeSeconds().ToString(), ClaimValueTypes.Integer64));
        ...
        public virtual async Task<Token> CreateAccessTokenAsync(TokenCreationRequest request)
        {
            ...
            claims.Add(new Claim(JwtClaimTypes.IssuedAt, new DateTimeOffset(DateTime.UtcNow).ToUnixTimeSeconds().ToString(),
