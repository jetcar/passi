...
namespace IdentityServer4.Validation.Default
{
    ...
    public class SecretValidator : ISecretsListValidator
    {
        ...
        public SecretValidator(IEnumerable<ISecretValidator> validators, ILogger<ISecretsListValidator> logger)
        {
        ...
        public async Task<SecretValidationResult> ValidateAsync(IEnumerable<Secret> secrets, ParsedSecret parsedSecret)
        {
            ...
            var expiredSecrets = secretsArray.Where(s => s.Expiration.HasExpired(DateTime.UtcNow)).ToList();
            ...
            var currentSecrets = secretsArray.Where(s => !s.Expiration.HasExpired(DateTime.UtcNow)).ToArray();
