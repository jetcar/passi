...
[Service(Exported = false, DirectBootAware = true, ForegroundServiceType = ForegroundService.TypeDataSync,
    Enabled = true)]
...
public class MyFirebaseMessagingService : FirebaseMessagingService
{
    ...
    private void SendNotification(string title, string body)
    {
        ...
        var notificationBuilder = new NotificationCompat.Builder(ApplicationContext, MainActivity.CHANNEL_ID)
            ...
            .SetLargeIcon(BitmapFactory.DecodeResource(Resources, Resource.Drawable.notification_icon_background))
             .SetAutoCancel(true)
             .SetNumber(1)
